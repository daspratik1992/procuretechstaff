                ...
                <div class="col-lg-10 col-md-10 col-sm-10">
                    ...
                    <li><a href="about.html" class="hvr-curl-top-left">About Us<i class="fa fa-angle-down"></i></a>
						<ul>
							...
							<li class="active"><a href="quality.html">Quality Standard</a></li>
						</ul>	
					</li>
		...
		<div class="row">
			<div class="col-lg-12 wow fadeInDown animated">
				<div class="deli_sec1">
					...
					<p>We at Procure Tech Staff know that our clients want the most trustworthy and reliable staffing services. We want our customers to know how serious we are about following quality standards and government policies.
<br>
Due to our global range of secure & discrete services we have achieved the ISO 27001:2013 ISMS business standard.</p>
					
				</div>	
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="deli_sec1">
					<h4 class=" wow fadeInLeft animated">What difference does the ISO 27001 standard make?</h4>
					<p style="text-align: left;">In this standard Procure Tech ensures a set of standards that help in keeping business information and data assets secure.</p>
					<span>We use below standards to ensure the secure management of data assets:</span>
					<ul class=" wow fadeInLeft animated">
						<li>Accounts & Financial Information</li>
						<li>Big Data Assets Information</li>
						<li>Employee Database Information</li>
						<li>Intellectual Property Information</li>
