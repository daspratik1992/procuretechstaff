...
<body>
                ...
                <div class="col-lg-10 col-md-10 col-sm-10">
                    ...
                    <li><a href="service.html" class="hvr-curl-top-left">Services<i class="fa fa-angle-down"></i></a>
                    	<ul>
							...
							<li class="active"><a href="payroll.html">Payroll & IC validation</a></li>
                        </ul>
                    </li>
    ...
    <div class="banner_innr">
		<img src="images/payroll.png" alt="">
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 wow fadeInDown animated">
				<div class="deli_sec1">
					<h2>Payroll</h2>
					<p>Procure Tech is an exclusive payroll provider for several large corporations, in addition to delivering them solutions such as transitioning and staff augmentation. Our payroll process includes:</p>
					<ul>
						<li>Complete Validation</li>
						<li>Induction</li>
						<li>Communication Management</li>
					</ul>
					<h4>Independent Contractor (IC) Validation</h4>
					<p style="text-align: left;">According to Staffing Industry Analysts’ 2009 Buyer Survey, less than 20% of all employers are confidently aware about the 100% compliance of all their 1099/independent contractors. The research also found that, larger company size leads to further doubts in compliancy.<br>

Procure Tech Staff offers IC validation and compliance services that directly address all IRS guidelines.</p>
