                ...
                <div class="col-lg-10 col-md-10 col-sm-10">
                    ...
                    <li><a href="service.html" class="hvr-curl-top-left">Services<i class="fa fa-angle-down"></i></a>
                    	<ul>
                            ...
                            <li class="active"><a href="software development.html">Software Development Solution</a></li>
		...
		<div class="row">
			<div class="col-lg-12 wow fadeInDown animated">
				<div class="deli_sec1">
					...
					<p>We are one of the top software development companies in delivering business intelligence applications, computer software, client/server software application, custom software development services, workflow application, desktop applications, and other software solutions to help businesses perform better and boost their ROI.</p>
				</div>	
			</div>
		</div> 
	</div>	
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<p>As a software development outsourcing company, we provide an array of development solutions. These include</p>
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					...
					<p>Desktop Applications & Software Development</p>
					</div>
					</li>
					...
					<p>Software Maintenance & Enhancement</p>
					</div>
					</li>
					...
					<p>Dashboard Development Services</p>
					</div>
					</li>
					<li>
					<div class="check-icon"><i class="fa fa-check"></i></div>
					...
					<p>Software Design and Testing</p>
					</div>
					</li>
					<li>
					<div class="check-icon"><i class="fa fa-check"></i></div>
					...
					<p>Microsoft .NET Application Development</p>
					</div>
					</li>
						<li>
					<div class="check-icon"><i class="fa fa-check"></i></div>
					...
					<p>Software Consulting Services</p>
					</div>
					</li>
					</ul>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6">
					...
					<p>Mac Application Development</p>
					</div>
					</li>
					...
					<p>Custom software development services to strengthen security for Stock Market Investment websites</p>
					</div>
					</li>
						<li>
					<div class="check-icon"><i class="fa fa-check"></i></div>
					...
					<p>Custom dashboard application development in Sharepoint for easy project management</p>
					</div>
					</li>
						<li>
					<div class="check-icon"><i class="fa fa-check"></i></div>
					...
					<p>Development of a desktop messaging application</p>
					</div>
					</li>
					</ul>
				</div>
...
<!--<h4>Do you want to know more about Website Design & Development by us? <a href="tel:555-555-5555">Contact us now. </a> </h4>-->
